  ...
  ({ label, error, requiredAsterisk = false, className = '', ...props }, ref) => {
    return (
      <div className="flex flex-col w-full gap-1">
        ...
        <input
          ref={ref}
          className={`px-3 py-2 text-sm border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-150 ${
